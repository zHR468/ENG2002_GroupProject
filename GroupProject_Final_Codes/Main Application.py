    ...
    while True:#Continuous loop
        ...
        if choice == 'a': #Addition function for two fixed numbers
            ...
            if isinstance(result, tuple):#The result is retrieved as tuple
                ...
                print(f"Estimation is -> {int(result[0].num/result[0].den)**(1/result[1].lstrip('to the power of 1/'))}")#Provides an estimation where exact value division is a long number and output is a float-point numnber.
